...
Esta es la página personal de Iván Alonso. Si nos conocemos quizá haya sido con el nombre de **Folken** ([muds](http://en.wikipedia.org/wiki/MUD) varios, [cYbErDaRk.NeT](http://www.cyberdark.net/index2.php)), **Ddraencara** (~~[XBox Live](https://live.xbox.com/es-ES/Profile?pp=0&GamerTag=ddraencara)~~ o [World of Warcraft](http://eu.battle.net/wow/en/character/shendralar/Ddraencara/) por ejemplo) o, desde hace ya tiempo, **neverbot** ([Xbox Live](https://account.xbox.com/es-es/profile?gamertag=neverbot5133)), el _nick_ más habitual que utilizo.
