...
{% year "34 ABY" "Star Wars: Resistance (_temporada 2_)" "2019, Tv, Animación (1 temporada, 18 capítulos)" %}
...
{% year " " "The Ewok Adventure" "1984, Tv" %}
![img](./index/220px-Caravan_bg.jpeg){.left width=150px}{% badge "orange" "No canon" %}
{% endyear %}

{% year " " "Ewoks: The Battle for Endor" "1985, Tv" %}
